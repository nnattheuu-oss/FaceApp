...
/*
 * Payments. The Lemon Squeezy checkout links that lived here were removed for
 * launch v1 (DR-2026-09-23-LAUNCH-V1): an app distributed on Google Play must
 * sell digital content through Play Billing, and a hosted web checkout linked
 * from inside the app is exactly what Play's Payments policy prohibits. The
 * catalogue now lives in billing/catalogue.js and prices come from Play.
 */
