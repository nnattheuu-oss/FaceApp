...
function integratedStoryMarkup(model, paywall = null) {
  ...
  const palaceSection = locks.palaces ? "" : `<section class="structure-section palace-collection" id="palace-collection">
      ...
      <div class="palace-heading"><div><h2>Twelve palaces, read as reflection</h2>
      <p class="muted">${model.palaces.measuredCount} of ${model.palaces.totalCount} regions were clearly visible in this scan. ${esc(INTERPRETATION_LABEL)}</p></div>
